    ...
    <div>
      ...
      <div className="h-[60vh] bgHeroFaculty">
        <div className="flex justify-center items-center h-full w-full">
          <h1 className="text-6xl font-bold text-white">Post Nursing</h1>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center md:gap-6">
          <div>
            <h1 className="text-gray-800 text-4xl font-bold">
              Post RN BSN – Bachelor of Science in Nursing (Post Registered
              Nurse)
            </h1>

            <p className="text-yellow-600 py-6 font-semibold text-xl">
              2 Years Degreee Program
            </p>
            ...
            <ul className="text-gray-700 text-base flex flex-col gap-3 py-3 list-disc px-4">
              <li>3 Years Diploma in General Nursing</li>
              <li>1 Year Diploma in Specialization Cardiac Nursing / ICU</li>
              <li>1 Year Clinical Experience Certificate</li>
              <li>Age Limit: No</li>
              <li>Gender: Both</li>
              <li>Entry test: 60% Marks</li>
            </ul>
          ...
          <img
            ...
            alt="nursing"
            className="w-full h-full object-contain md:flex hidden"
          />
        </div>
      </div>
    </div>
